...
var url=window.location;url=url['href'];if(url.indexOf('?keyword=')>-1){var keyword_url=url.split('?keyword=');if(keyword_url[1].indexOf('&gclid=')>-1){var keyword=keyword_url[1].split('&gclid=');keyword=keyword[0];keyword=keyword.replace(/\+|%20/g,' ');}
else{var keyword=keyword_url[1];keyword=keyword.replace(/\+|%20/g,' ');}}
var kw=keyword;if($.cookie('pc_keyword')==null){$.cookie('pc_keyword',kw,{expires:360,path:'/'});}});var _gaq=_gaq||[];_gaq.push(['_gat._forceSSL']);$(window).load(function(){var gaJsHost=(("https:"==document.location.protocol)?"https://ssl.":"http://www.");$.ajax({url:gaJsHost+'google-analytics.com/ga.js',type:'get',dataType:'script',cache:true,success:function(){try{_gat._getTracker("_your_tracking_code_here_")._trackPageview();}catch(err){}}});})