...
<tr>
   ...
   $nation=$this->db->get('circular'); 
     if($nation->num_rows()>0){
         $i=1;
        foreach($nation->result() as $cir): ?>
        <td></td>
   <td><a href="<?php echo base_url();?>admin/assets/images/circular/<?php echo $cir->image ;?>"><img src="<?php echo base_url();?>assets/images/down.png" alt="member" width="90" height="100"></a></td>
     <td></td>
     <td style="font-size:120%;"><a href="<?php echo base_url();?>admin/assets/images/circular/<?php echo $cir->image ;?>"><?php echo $cir->image;?></a>
     </br>
     <p style="font-size:80%; color:brown;"><?php echo $cir->date;?></p>
     <p style="font-size:80%; color:brown;"><?php echo $cir->discription;?></p>
     </td>
   </tr>
   <?php $i++;  endforeach; } ?>
</table>
