...
function mysms($number,$msg){

 $url = "http://mysms.sms7.biz/rest/services/sendSMS/sendGroupSms?AUTH_KEY=8e1892c39a2fd497b30b83fd4ff22e&message=".urlencode($msg)."&senderId=NIKSCH&routeId=1&mobileNos=".$number."&smsContentType=english";
 	$ch = curl_init();
