...
function profile(){
	...
	public function product_category(){
		...
		$data['smallTitle'] = "Website/Product category";
		$data['bigTitle'] = "Product category List";
		$data['headerCss'] = 'headerCss/customerlistcss';
		$data['footerJs'] = 'footerJs/customerlistjs';
		$data['mainContent'] = "chaanan/product_category";
		$this->load->view("includes/mainContent",$data);
	}
	public function cod()
