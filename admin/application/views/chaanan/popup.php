            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      	<form method="post"	action="<?php echo base_url()?>index.php/apanelForms/popup" enctype="multipart/Form-data" >
							<div class="card-body">
                    ...
                    <div class="table-responsive">
                     ...
                     <?php $popup=$this->db->get("popup_image");?>
                        <thead>
                          <tr>
                        ...
                        <?php $i=1; foreach($popup->result() as $row):?>
                         <tr>
                             ...
                             <td><button type="button" class="btn btn-danger">
                                 	<a href="<?php echo base_url();?>apanelForms/deletepopup/<?php echo $row->sno;?>">
